...
<html lang="en">
<head>
    <title>Library - Change Profile Info</title>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-light bg-primary" >
    ...
    <font color="white"><a class="nav-link" href="#">Change Profile Info</a></font>
</nav>
<#if message??>
...
<div class="form-group row mt-4 mx-4">
    ...
    <input type="date" style="width : 400px;" name="dateOfBirthday" <#if oldDateOfBirthday??>value = "${oldDateOfBirthday}"</#if> <#if dateOfBirthday??>class="form-control is-invalid" <#else> class="form-control" </#if> >
<#if dateOfBirthday??>
<div class="invalid-feedback" style="margin-left : 220px">
    ${dateOfBirthday}
</div>
