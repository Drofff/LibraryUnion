...
<div class="card text-center mx-auto my-5" style="width : 50%;">
    ...
    <div class="card-body">
        <h5 class="card-title">It is time to choose</h5>
        <p class="card-text">Create, our library union card and share all the best books from libraries in one click. Awesome world of books is waiting!</p>
        <a href="/libraryCard" class="card-link">Create library card</a>
        <a href="/libraryAccount" class="card-link">I am library</a>
    </div>
