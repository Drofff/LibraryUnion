...
<div class="card text-center mx-auto my-5" style="width : 50%;">
    ...
    <div class="card-body">
        <h5 class="card-title" style="font-size:22px;">Dear User!</h5>
        <p class="card-text">As a response for your ask to recover password, we have sent you a new password to your mail box ${email}</p>
    </div>
